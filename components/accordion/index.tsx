...
const Index = ({ title, content }: IProps) => {
  ...
  return (
    <div className="accordion-item mx-2 my-3">
      ...
      >
        <div className="uppercase font-JosefinSans text-sm md:text-md">
          {title}
        </div>
      ...
      {isActive && (
        <div className="accordion-content md:text-md md:text-left font-JosefinSans text-center text-white text-sm p-4">
          {content}
        </div>
      )}
    </div>
