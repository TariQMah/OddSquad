  ...
  return (
    <div className=" hidden  mb-12 mx-6 md:grid grid-cols-12 gap-4 justify-between">
      ...
      <div className="flex col-span-7 justify-center items-center">
        ...
        <h3 className="text-white font-JosefinSans font-medium text-md">
          <Link href={"#"}>FAQ</Link>
        </h3>
      </div>
      <div className="col-span-3 items-center justify-end flex">
        <div className="flex items-center justify-end">
          ...
          <div className="rounded-full py-2 px-3 flex justify-center items-center  font-JosefinSans text-black bg-white">
            Connect Wallet
          </div>
        </div>
      </div>
