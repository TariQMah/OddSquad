  ...
  return (
    <div id="home">
      <Head>
        ...
        <div
          className={`menu fixed z-50 w-full overflow-hidden bg-black opacity-90 backdrop-blur-md	 h-full ease-linear transition-all ${!showMenu ? "-translate-x-[100%]" : "translate-x-[0]"}`}
          ref={menu}
        >
          <div className="h-full w-full fixed px-2">
            <Link
              activeClass="active"
              className="mt-2"
              to="home"
            ...
            >
              <img
                src={"/svg-img/sideBarlogo.svg"}
                className=" object-contain mb-20  relative top-7 left-2 w-[98px] h-[45.97px] mt-6"
                width={120}
                height={120}
              />
            </Link>
            ...
            <div className="absolute flex flex-col bottom-[108px] tracking-wide w-full items-center">
            <Newake tag="h4" size="text-[12px] font-normal ">
              JOIN OUR COMMUNITY
            </Newake>
            ...
            <Button className="mt-16"  text={"CONNECT WALLET"} />
        </div>
        ...
        <div className="overlayPattern">
          ...
          <div className="screen1 section relative" ref={ref}>
            <div className="logo mt-10 z-30 relative flex justify-center">
              <img src="images/mainLogo.png" className="md:hidden mt-14" />
              <img
            ...
            <div className="md:hidden">
              <Newake className={'text-[12px] track-[o.1em]'} tag="h4">MINT AVAILABLE Q3 2022</Newake>
          ...
          >
            <div className="w-full py-12  relative text-center">
              <img
                ...
                className="absolute right-4 top-12 md:hidden"
              />
              <img
              ...
              <Newake
                ...
                color="white"
                padding="px-2"
                margin="mt-5 mb-20 mt-12  md:mx-auto"
